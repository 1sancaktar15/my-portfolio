...
function App() {
  return (
    <div className="bg-offwhite min-h-screen font-sans">
      {/* Header / Home */}
      <header className="bg-darkgreen text-offwhite py-10 shadow-lg">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-2">Elif Özün</h1>
          <p className="text-lg mb-4">Computer Engineering Graduate</p>
      ...
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">About Me</h2>
      ...
      {/* Projects */}
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">Projects</h2>
        <div className="space-y-5">
          <div className="bg-beige rounded-lg p-4 shadow hover:shadow-lg transition">
          ...
          <section className="max-w-3xl mx-auto py-10 px-4">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-beige rounded-lg p-4 shadow hover:shadow-lg transition">
                <h3 className="font-bold text-lg">RoboFriends (React App)</h3>
                <p>
                  Built an interactive React-based web app with real-time data rendering.
                </p>
                <div className="flex gap-4 mt-2">
                  <a
                    href="https://github.com/1sancaktar15/frontend-project-robofriends"
                    className="underline text-darkgreen font-medium hover:text-forest transition"
                    target="_blank" rel="noopener noreferrer"
                  >
                    GitHub Repository
                  ...
                  <a
                    href="https://1sancaktar15.github.io/frontend-project-robofriends/"
                    className="underline text-darkgreen font-medium hover:text-forest transition"
                    target="_blank" rel="noopener noreferrer"
                  >
                    Live Demo
              ...
              <div className="bg-beige rounded-lg p-4 shadow hover:shadow-lg transition">
                ...
                <div className="flex gap-4 mt-2">
                  <a
                    href="https://github.com/1sancaktar15/bigdata-project"
                    className="underline text-darkgreen font-medium hover:text-forest transition"
                    target="_blank" rel="noopener noreferrer"
                  >
                    GitHub Repository
          ...
          {/* Yeni projelerini buraya ekleyebilirsin */}
        </div>
      </section>

      {/* Experience */}
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">Experience</h2>
        <div className="space-y-5">
          <div>
            <h3 className="font-bold">T5 Systems | Full Stack Development Intern</h3>
            <span className="italic text-sm">Jul 2023 - Sep 2023</span>
            <ul className="list-disc ml-6 text-charcoal text-base">
      ...
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">Technical Blog & Internship Diaries</h2>
        ...
        <ul className="list-disc ml-6 text-charcoal text-base space-y-2">
          <li>
            <a
      ...
      {/* Skills */}
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">Skills</h2>
        <ul className="list-disc ml-6 text-charcoal text-base">
      ...
      {/* Education */}
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">Education</h2>
        <ul className="list-disc ml-6 text-charcoal text-base">
          <li>
      ...
      {/* Resume/CV */}
      <section className="max-w-3xl mx-auto py-10 px-4">
        <h2 className="text-2xl font-semibold text-darkgreen mb-3">Resume / CV</h2>
        <a
